...
在本练习中，你已了解如何使用 GitHub Copilot 加速开发 C# 应用程序中的单元测试。 你在询问模式、代理模式和编辑模式下使用了 GitHub Copilot 的聊天视图。 你使用了询问模式检查现有的单元测试方法、用于创建项目文件夹和新测试类的智能体模式，以及用于创建单元测试的编辑模式。 你还使用了 GitHub Copilot 的代码补全功能来创建单元测试。
