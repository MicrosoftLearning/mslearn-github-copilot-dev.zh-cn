...
本文档包含示例 PRD 集合，演示如何有效地将 PRD 模板用于氛围编码项目。
...
本部分包含示例 PRD，演示如何有效地使用 PRD 模板进行氛围编码

### 示例 1 - 宠物领养 Web 应用产品需求文档 (PRD)
...
### 示例 2 - 来自 DevDiv 团队的 Wendy（针对 MyTodoListApp 的 Copilot 自定义说明）
